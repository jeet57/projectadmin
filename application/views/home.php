            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <?php /*<a href="javascript:void(0)" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Buy Admin Now</a>*/?>
                        <ol class="breadcrumb">
                            ...
                            <div class="row row-in">
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <ul class="col-in">
                                        ...
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15"><?php echo $property;?></h3>
                                        </li>
                                        <li class="col-middle">
                                            <h4>Property</h4>
                                            <div class="progress">
                            ...
                            echo $tenant;
                             ?></h3>
                                ...
                                <div class="col-lg-3 col-sm-6  b-0">
                                    <ul class="col-in">
                                        <li>
                                            <span class="circle circle-md bg-warning"><i class="fa fa-home"></i></span>
                                        </li>
                                        <li class="col-last">
                                            <h3 class="counter text-right m-t-15"><?php 
                            echo $owner;
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="manage-users">
                            <div class="sttabs tabs-style-iconbox">
                                <nav>
                                    <ul>
                                        <li><a href="#section-iconbox-1" class="sticon ti-user"><span>Agents</span></a></li>
                                        <li><a href="#section-iconbox-2" class="sticon ti-lock"><span>Tenant</span></a></li>
                                        <li><a href="#section-iconbox-3" class="sticon ti-receipt"><span>Owner</span></a></li>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="advance-table-row active">
                                                        ...
                                                        <td style="width: 60px;"><img src="<?php echo base_url();?>assets/uploads/<?php echo $datas->profile_photo; ?>" class="img-circle" width="40" heigh="40" alt="user img" /></td>
                                                        <td><?php  echo $datas->first_name;?> <?php echo $datas->last_name;?></td>
                                                        <td><?php  echo $datas->email;?></td>
                                                        <td><?php  echo $datas->mobile_no;?></td>
                                                        <td><?php  echo $datas->landline_no;?></td>
                                                        <td><?php  echo $datas->state;?>, <?php echo $datas->city;?></td>
