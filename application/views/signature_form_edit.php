							...
							?>
                                <div class="">
                                    ...
                                    <div class="scrollable">
                                      ...
                                      <?php echo form_open(base_url().'agreementform/edit/'.$id, 'class="form-horizontal form-material" id="planform" name="plan" ');?>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-md-12 m-b-20">
                                                 <textarea name="description" class="form-control" placeholder="description" id="mymce"><?php echo $description;?></textarea><?php echo form_error('description');?></div>
                                              
												 <div class="col-md-12 m-b-20">
											
                                                <input type="radio" name="paytype"  class="paytype"  value="Free" <?php echo set_radio('paytype', 'Free',(($paytype=='Free')?True:False))?>>Free
												<input type="radio" name="paytype"   class="paytype" value="Paid" <?php echo set_radio('paytype', 'Paid',(($paytype=='Paid')?True:False)) ?>>Paid </div>
                                          
										<div id="agreement_paid" <?php if($paytype=='Free'){echo 'style="display:none"';}?>>
                                           <div class="col-md-3 m-b-20">
											...
											<div class="col-md-3 m-b-20">												
												<?php	echo "<small>".form_error('form_name')."</small>";
													...
													echo form_dropdown('currency', $options, $currency,'class="form-control"');
												?>
