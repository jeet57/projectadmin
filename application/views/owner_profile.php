<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url();?>assets/uploads/Desert.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                         <?php foreach($data as $owner_data){

                                    ?>
                                        <a href="javascript:void(0)"><img src="<?php echo base_url();?>assets/uploads/Desert.jpg" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white"><?php echo $owner_data->first_name.' '.$owner_data->last_name; ?></h4>
                                        <h5 class="text-white"><?php echo $owner_data->email; ?></h5> </div>
                                </div>
                            </div>
                        ...
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                               <!-- <li class="active tab">
                                ...
                                <li class="active tab">
                                    <a href="#profiles" data-toggle="tab"> <span class="visible-xs"><i class="fa fa-user"></i></span> <span class="hidden-xs">Profile</span> </a>
                                </li>
                                <!--<li class="tab">
                               ...
                               <!-- <div class="tab-pane active" id="home">
                                ...
                                <div class="tab-pane active" id="profiles">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $owner_data->first_name.' '.$owner_data->last_name; ?></p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Mobile</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $owner_data->mobile_no; ?></p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Email</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $owner_data->email; ?></p>
                                        </div>
                                        <div class="col-md-3 col-xs-6"> <strong>Location</strong>
                                            <br>
                                            <p class="text-muted"><?php echo $owner_data->country; ?></p>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <!--<div class="tab-pane" id="messages">
                                    <div class="steamline">
                                        ...
                                        <div class="sl-item">
                                            <div class="sl-left"> <img src="<?php echo base_url();?>assets/upload/Desert.jpeg; ?>" alt="user" class="img-circle" /> </div>
                                            <div class="sl-right">
                                                <div class="m-l-40"><a href="#" class="text-info">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                    <p class="m-t-10"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper </p>
                                                </div>
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <form class="form-horizontal form-material" id="form" name="form" onsubmit="return validateForm()">
                                        <div class="form-group">
                                            <label class="col-md-12">Full Name</label>
                                            <div class="col-md-12">
                                                <input name="name" type="text" placeholder="Johnathan Doe" class="form-control form-control-line" value="<?php echo $owner_data->first_name.' '.$owner_data->last_name ?>"> </div>
                                        </div>
                                         <div class="form-group">
                                            <input type="hidden" name="hidden_value" value="<?php echo $owner_data->assets_id; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email" class="col-md-12">Email</label>
                                            <div class="col-md-12">
                                                <input type="email" placeholder="johnathan@admin.com" class="form-control form-control-line" name="email" id="email" value="<?php echo $owner_data->email; ?>"> </div>
                                        </div>
                                        <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="phone" name="phone" type="text" placeholder="123 456 7890" class="form-control form-control-line" value="<?php echo $owner_data->mobile_no; ?>"> </div>
                                        </div>
                                        <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control form-control-line" id="country" name="country">
                                                    <option value="london" <?php echo $owner_data->country == 'london' ? 'selected' : ''?>>London</option>
                                                    <option value="india" <?php echo $owner_data->country == 'india' ? 'selected' : ''?>>India</option>
                                                    <option value="usa" <?php echo $owner_data->country == 'usa' ? 'selected' : ''?>>Usa</option>
                                                    <option value="canada" <?php echo $owner_data->country == 'canada' ? 'selected' : ''?>>Canada</option>
                                                    <option value="thailand" <?php echo $owner_data->country == 'thailand' ? 'selected' : ''?>>Thailand</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    var country = document.forms["form"]["phone"].value;
    if (country == "") {
        alert("Coutry must be filled out");
        return false;
    }
    else{
        ...
        //alert(data);
        $.ajax({
            url:'<?php echo base_url();?>user/updateOwnerProfile',
            data:data,
            dataType:'json',
            type:'post',
