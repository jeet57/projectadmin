        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                   <?php /*<li class="user-pro">
                        <a href="#" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i><?php /*<img src="<?php echo base_url();?>assets/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> <?php echo $this->session->userdata('username');?><span class="fa arrow"></span></span>
                        </a>
                        <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                            <li><a href="<?php echo base_url();?>profile"><i class="ti-user"></i> <span class="hide-menu">My Profile</span></a></li>
                            <?php /*<li><a href="javascript:void(0)"><i class="ti-wallet"></i> <span class="hide-menu">My Balance</span></a></li>
                            <li><a href="javascript:void(0)"><i class="ti-email"></i> <span class="hide-menu">Inbox</span></a></li>
                            <li><a href="javascript:void(0)"><i class="ti-settings"></i> <span class="hide-menu">Account Setting</span></a></li>
                            <li><a href="<?php echo base_url();?>logout"><i class="fa fa-power-off"></i> <span class="hide-menu">Logout</span></a></li>
                        </ul>
                    </li>*/?>
					
                    <li> <a href="<?php echo base_url();?>dashboard" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> Dashboard <span class="label label-rouded label-inverse pull-right">4</span></span></a>
                    </li>
					<li> <a href="<?php echo base_url();?>owner" class="waves-effect"><i class="mdi mdi-account fa-fw"></i> <span class="hide-menu">Owner Management  <?php /*<span class="label label-rouded label-info pull-right">20</span><span class="fa arrow"></span>*/?> </span></a></li>
					<li> <a href="<?php echo base_url();?>agent" class="waves-effect"><i class="mdi mdi-account-outline fa-fw"></i> <span class="hide-menu">Agent Management</span></a></li>
					<li><a href="<?php echo base_url();?>tenant" class="waves-effect"><i class="mdi mdi-account-circle fa-fw"></i> <span class="hide-menu">Tenant Management</span></a></li>
					<li><a href="<?php echo base_url();?>property" class="waves-effect"><i class="mdi mdi-home fa-fw"></i> <span class="hide-menu">Property Management</span></a></li>
					
					<li> <a href="#" class="waves-effect"><i class="fa-fw">P</i> <span class="hide-menu">Plan<span class="fa arrow"></span>  </span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url();?>plan"><i data-icon="&#xe026;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Plan Master</span></a></li>
                            <li><a href="<?php echo base_url();?>features"><i data-icon="&#xe025;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Features</span></a></li>
                            <li><a href="<?php echo base_url();?>featuremapper"><i class="ti-layout-menu fa-fw"></i> <span class="hide-menu">Plan Feature Mapping</span></a></li>
                        </ul>
                    </li>
					
					
					<li><a href="<?php echo base_url();?>transaction" class="waves-effect"><i class="mdi mdi-cash fa-fw"></i> <span class="hide-menu">Transaction</span></a></li>
					<li><a href="<?php echo base_url();?>blog" class="waves-effect"><i class="mdi mdi-blogger fa-fw"></i> <span class="hide-menu">Blog </span></span></a></li>
					<li><a href="<?php echo base_url();?>advertisment" class="waves-effect"><i class="mdi mdi-blogger fa-fw"></i> <span class="hide-menu">Advertisment </span></span></a></li>
					<li><a href="<?php echo base_url();?>testimonial" class="waves-effect"><i class="mdi mdi-clipboard-text fa-fw"></i> <span class="hide-menu">Testimonial </span></span></a></li>
					
					<li> <a href="<?php echo base_url();?>agreementform" class="waves-effect"><i class="fa-fw">A</i> <span class="hide-menu">Agreement Form  </span></a>
                       <?php /* <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url();?>propertyform"><i data-icon="&#xe026;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Property Forms</span></a></li>
                            <li><a href="<?php echo base_url();?>signatureform"><i data-icon="&#xe025;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Signature Forms</span></a></li>
                        </ul>*/?>
                    </li>
					<li><a href="<?php echo base_url();?>settings" class="waves-effect"><i class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Setting </span></a></li>
					<li><a href="<?php echo base_url();?>portalcontent" class="waves-effect"><i class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Portal Content </span></a></li>
					
					
                    <?php /*<li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">UI Elements<span class="fa arrow"></span> <span class="label label-rouded label-info pull-right">20</span> </span></a>
                        <ul class="nav nav-second-level">
                   ...
                   <?php /* <li> <a href="#" class="waves-effect"><i class="mdi mdi-content-copy fa-fw"></i> <span class="hide-menu">Sample Pages<span class="fa arrow"></span><span class="label label-rouded label-warning pull-right">30</span></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <?php /*<li><a href="inbox.html" class="waves-effect"><i class="mdi mdi-apps fa-fw"></i> <span class="hide-menu">Apps<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li><a href="<?php echo base_url();?>logout" class="waves-effect"><i class="mdi mdi-logout fa-fw"></i> <span class="hide-menu">Log out</span></a></li>
                    <?php /*<li class="devider"></li>
